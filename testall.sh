...
Usage() {
    echo "Usage: testall.sh [options] [.mike files]"
...
Check() {
    ...
    Run "$CC" "-o" "${basename}.exe" "${basename}.s" "src/synth.o"  "src/make_midi.o" &&
...
then
    ...
    files="tests/test-*.mike tests/fail-*.mike"
fi
